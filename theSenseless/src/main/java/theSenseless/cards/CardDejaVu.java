...
public class CardDejaVu extends AbstractDynamicCard {
    ...
    public static final String ID = SenselessMod.makeID("CardDejaVu"); // DELETE THIS ONE.
    ...
    public CardDejaVu() { // public ${NAME}() - This one and the one right under the imports are the most important ones, don't forget them
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(new WiltAction("exhaust"));
    }
