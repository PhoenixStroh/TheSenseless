...
public class CardFlashKick extends AbstractDynamicCard {
    ...
    public static final String ID = SenselessMod.makeID("CardFlashKick"); //DefaultCommonSkill.class.getSimpleName()
