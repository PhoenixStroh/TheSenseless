...
public class CardBurial extends AbstractDynamicCard {
    ...
    public static final String ID = SenselessMod.makeID("CardBurial"); //DefaultCommonSkill.class.getSimpleName()
