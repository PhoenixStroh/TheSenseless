...
public class CardDefend extends AbstractDynamicCard {
    ...
    public static final String ID = SenselessMod.makeID("CardDefend"); //DefaultCommonSkill.class.getSimpleName()
